...
You can also deploy the {{site.data.keyword.agent}} to collect and route logs from your own workloads on {{site.data.keyword.cloud_notm}} or outside {{site.data.keyword.cloud_notm}} through the {{site.data.keyword.logs_routing_full_notm}} service. For example, you can configure the {{site.data.keyword.agent}} to collect and route logs generated by applications that run on your [Kubernetes](/docs/containers) or [OpenShift](/docs/openshift) clusters.
