...
# How do I migrate from {{site.data.keyword.logs_routing_full}} V1 to V3 in an {{site.data.keyword.cloud_notm}} account
{: #v3-migration}
...
2. **Manual Configuration**:
    ...
    - [Manual migration from V1 to V3 for new accounts (No V1 Setup)](/docs/logs-router?topic=logs-router-v3-migration-manual-new-acc).

    - [Manual migration from v1 to v3 for existing accounts (With V1 Setup)](/docs/logs-router?topic=logs-router-v3-migration-manual-existing).
