...
# How do I route all platform logs generated in an {{site.data.keyword.cloud_notm}} account to multiple destination targets using {{site.data.keyword.logs_routing_full}}
{: #route-rule-all-logs}

Route all platform logs that are generated by {{site.data.keyword.cloud_notm}} services in all of the {{site.data.keyword.logs_routing_full_notm}} supported locations to multiple destination targets.
{: shortdesc}
...
## What are the CLI prerequisites to route all platform logs generated in an {{site.data.keyword.cloud_notm}} account to multiple destination targets using {{site.data.keyword.logs_routing_full}}
